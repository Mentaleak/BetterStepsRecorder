...
{
    partial class ScreenshotDragCropped
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            lblNote.TabIndex = 0;
            lblNote.Text = "Configure padding around the drag path for cropped screenshots:";
            // 
            // lblPadding
            // 
            ...
            nudPadding.Value = new decimal(new int[] { BSRSettings.Default.Screenshot.Drag.Cropped.Padding, 0, 0, 0 });
            // 
