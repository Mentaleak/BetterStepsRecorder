    ...
    public class HtmlExporter : ExporterBase
    {
        ...
        public bool Export(string filePath, BSRSettings.HtmlSettings cfg)
        {
            try
            {
                ...
                html.AppendLine("                margin: 12mm;");
                html.AppendLine("            }");
                html.AppendLine("            * {");
                html.AppendLine("                box-shadow: none !important;");
                html.AppendLine("                text-shadow: none !important;");
                html.AppendLine("            }");
                html.AppendLine("            html, body {");
                html.AppendLine("                background: #fff !important;");
                html.AppendLine("                color: #000 !important;");
                ...
                html.AppendLine("                min-height: auto;");
                html.AppendLine("            }");
                html.AppendLine("            .page-header {");
                html.AppendLine("                padding: 16mm 0 6mm;");
                html.AppendLine("                background: #fff !important;");
                html.AppendLine("                color: #000 !important;");
                html.AppendLine("                border-bottom: 1px solid #ddd;");
                html.AppendLine("                break-after: avoid;");
                html.AppendLine("                page-break-after: avoid;");
                html.AppendLine("            }");
                html.AppendLine("            .page-header h1 {");
                html.AppendLine("                font-size: 18pt;");
                html.AppendLine("                margin-bottom: 3mm;");
                html.AppendLine("            }");
                html.AppendLine("            .page-header .meta,");
                html.AppendLine("            .summary-item,");
                html.AppendLine("            .progress-bar-wrap,");
                html.AppendLine("            .footer,");
                html.AppendLine("            #lb-overlay {");
                html.AppendLine("                display: none !important;");
                html.AppendLine("            }");
                html.AppendLine("            .container {");
                html.AppendLine("                max-width: none;");
                html.AppendLine("                padding: 0;");
                html.AppendLine("            }");
                html.AppendLine("            .step-card {");
                html.AppendLine("                margin: 0 0 6mm;");
                html.AppendLine("                border: 1px solid #ddd;");
                html.AppendLine("                border-radius: 6px;");
                html.AppendLine("                box-shadow: none;");
                html.AppendLine("                break-inside: avoid;");
                html.AppendLine("                page-break-inside: avoid;");
                html.AppendLine("                overflow: visible;");
                html.AppendLine("            }");
                html.AppendLine("            .step-card:hover {");
                html.AppendLine("                box-shadow: none;");
                html.AppendLine("            }");
                html.AppendLine("            .step-header {");
                html.AppendLine("                padding: 4mm 5mm;");
                html.AppendLine("                break-after: avoid;");
                html.AppendLine("                page-break-after: avoid;");
                html.AppendLine("            }");
                html.AppendLine("            .step-badge {");
                html.AppendLine("                background: #eee;");
                html.AppendLine("                color: #000;");
                html.AppendLine("                border: 1px solid #ccc;");
                html.AppendLine("            }");
                html.AppendLine("            .step-title {");
                html.AppendLine("                font-size: 10.5pt;");
                html.AppendLine("                color: #000;");
                html.AppendLine("            }");
                html.AppendLine("            .step-time,");
                html.AppendLine("            .step-delta,");
                html.AppendLine("            .detail-item .detail-label {");
                html.AppendLine("                color: #555;");
                html.AppendLine("            }");
                html.AppendLine("            .step-details {");
                html.AppendLine("                padding: 3mm 5mm;");
                html.AppendLine("                background: #fafafa;");
                html.AppendLine("                gap: 4px 12px;");
                html.AppendLine("            }");
                html.AppendLine("            .detail-item .detail-value {");
                html.AppendLine("                color: #000;");
                html.AppendLine("                word-break: break-word;");
                html.AppendLine("            }");
                html.AppendLine("            .step-body {");
                html.AppendLine("                padding: 4mm 5mm 5mm;");
                html.AppendLine("            }");
                html.AppendLine("            .step-body img {");
                html.AppendLine("                border: 1px solid #ddd;");
                html.AppendLine("                max-height: 170mm;");
